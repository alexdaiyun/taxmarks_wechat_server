...
"""
    weixinApi.oauth
    ~~~~~~~~~~~~~~~~
    This module provides OAuth2 library for weixin
"""
__author__ = 'alexday'
...
from .exceptions import WeiXinOAuthException


class WeiXinOAuth(object):
    """ 微信公众平台 OAuth 网页授权 """
    ...
    def __init__(self, app_id, secret, redirect_uri,
        ...
        """
        :param app_id: WeiXin app id
        :param secret: WeiXin app secret
        :param redirect_uri: OAuth2 redirect URI
        :param scope: WeiXin OAuth2 scope
        :param state: WeiXin OAuth2 state
        """
        self.app_id = app_id
        self.secret = secret
    ...
    def _request(self, method, url_or_endpoint, **kwargs):
        ...
        if 'errcode' in result and result['errcode'] != 0:
            ...
            raise WeiXinOAuthException(errcode, errmsg)
    ...
    def get_user_info(self, openid=None, access_token=None, lang='zh_CN'):
        """Get user infomation
        :param openid: WeiXin openid, optional
        :param access_token: WeiXin OAuth2 access token, optional
